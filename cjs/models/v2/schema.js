...
class Schema extends base_1.BaseModel {
    constructor(_json, _meta = {}) {
        var _a;
        _json = (0, utils_1.retrievePossibleRef)(_json, _meta.pointer, (_a = _meta.asyncapi) === null || _a === void 0 ? void 0 : _a.parsed);
        super(_json, _meta);
    }
    uid() {
        var _a;
        return this._meta.id || ((_a = this.extensions().get(constants_1.xParserSchemaId)) === null || _a === void 0 ? void 0 : _a.value());
    }
    $comment() {
    ...
    isCircular() {
        if ((0, utils_1.hasRef)(this._json))
            return true;
