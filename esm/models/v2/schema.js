...
export class Schema extends BaseModel {
    constructor(_json, _meta = {}) {
        var _a;
        _json = retrievePossibleRef(_json, _meta.pointer, (_a = _meta.asyncapi) === null || _a === void 0 ? void 0 : _a.parsed);
        super(_json, _meta);
    }
    uid() {
        var _a;
        return this._meta.id || ((_a = this.extensions().get(xParserSchemaId)) === null || _a === void 0 ? void 0 : _a.value());
    }
    $comment() {
