...
export declare type ServersObject = Record<string, ServerObject>;
...
export declare type ChannelsObject = Record<string, ChannelObject>;
...
export declare type ParametersObject = Record<string, ParameterObject | ReferenceObject>;
...
export declare type TagsObject = Array<TagObject>;
...
export declare type SchemaObject = AsyncAPISchemaObject | ReferenceObject;
export declare type AsyncAPISchemaObject = AsyncAPISchemaDefinition | boolean;
...
export declare type SecuritySchemeType = 'userPassword' | 'apiKey' | 'X509' | 'symmetricEncryption' | 'asymmetricEncryption' | 'httpApiKey' | 'http' | 'oauth2' | 'openIdConnect' | 'plain' | 'scramSha256' | 'scramSha512' | 'gssapi';
export declare type SecuritySchemaLocation = 'user' | 'password' | 'query' | 'header' | 'header' | 'cookie';
...
export declare type OAuthFlowObject = OAuthFlowObjectImplicit & OAuthFlowObjectPassword & OAuthFlowObjectClientCredentials & OAuthFlowObjectAuthorizationCode;
...
export declare type SecurityRequirementObject = Record<string, Array<string>>;
...
export declare type SpecificationExtension<T = any> = T;
