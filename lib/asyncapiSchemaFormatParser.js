 ...
 * @param {object} input.message message 
 * @param {string} input.originalAsyncAPIDocument AsyncAPI document
 * @param {string} input.fileFormat fileFormat
 * @param {object} input.parsedAsyncAPIDocument parsedAsyncAPIDocument
 * @param {string} input.pathToPayload pathToPayload
 * @param {string} input.defaultSchemaFormat defaultSchemaFormat
 */
...
/**
 * @private
 * @returns {Array} schema format array
 */
