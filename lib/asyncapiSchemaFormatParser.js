 ...
 * @param {string} options.originalAsyncAPIDocument AsyncAPI document
 * @param {string} options.fileFormat fileFormat
 * @param {object} options.parsedAsyncAPIDocument parsedAsyncAPIDocument
 * @param {string} options.pathToPayload pathToPayload
 * @param {string} options.defaultSchemaFormat defaultSchemaFormat
 */
