...
const xParserOriginalPayload = 'x-parser-original-payload';
 ...
 * @private
 */
async function parse({ schemaFormat, message, defaultSchemaFormat, originalAsyncAPIDocument, fileFormat, parsedAsyncAPIDocument, pathToPayload }) {
  // setting original schema format required before returning because of no payload
  message[String(xParserOriginalSchemaFormat)] = schemaFormat || defaultSchemaFormat;
