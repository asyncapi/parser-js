...
//TODO validate mapping and if array is empty if needed
...
function validateServerSecuritySchemaMapping(parsedJSON, asyncapiYAMLorJSON, initialFormat) {
  ...
  const secSchemes =  parsedJSON.components.securitySchemes;
  const secSchemesMap = new Map(Object.entries(secSchemes));

  //const ser
  secSchemesMap.forEach((val, schemeName) => {
