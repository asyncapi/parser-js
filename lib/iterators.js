 ...
 * 
 * @private
 * @param {Schema} schema schemaContent
 * @param {TraverseSchemas} callback traverseSchemas
 * @param {object | string} prop prop
 * @param {SchemaTypesToIterate[]} schemaTypesToIterate schemaTypesToIterate
 */
 ...
 * @private
 * @param {Schema} schema schemaContent 
 * @param {TraverseSchemas} callback traverseSchemas callback
 * @param {SchemaTypesToIterate[]} schemaTypesToIterate schemaTypesToIterate
 */
 ...
 * @param {FoundSchemaCallback} callback Found schema callback
 * @param {SchemaTypesToIterate[]} schemaTypesToIterate schemaTypesToIterate
 */
 ...
 * @param {TraverseSchemas} callback traverse schemas callback
 * @param {SchemaTypesToIterate[]} schemaTypesToIterate schemaTypesToIterate
 */
