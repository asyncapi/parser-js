const { getMapValueOfType } = require('../utils');
...
const MixinExternalDocs = {
  /**
   * @returns {boolean} true if it has external docs, otherwise false
   */
  hasExternalDocs() {
  ...
  /**
   * @returns {(ExternalDocs | null)} external docs if it exists, otherwise null
   */
  externalDocs() {
