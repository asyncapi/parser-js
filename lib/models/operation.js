...
class IntentOperation {
   ...
   */
  constructor(document, channelId, operationTypes) {
    if (document === undefined || document === null || channelId === undefined || channelId === null || operationTypes === undefined || operationTypes === null) throw new ParserError(`Invalid JSON to instantiate the ${this.constructor.name} object.`);
   ...
   */
  types() { return this.operationTypes; }
