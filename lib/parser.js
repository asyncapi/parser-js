...
async function parse(asyncapiYAMLorJSON, options = {}) {
  ...
  try {
    ...
    await dereference(parsedJSON, initialFormat, asyncapiYAMLorJSON, { ...options, dereference: 'ignore' });
...
async function handleCircularRefs(parsedJSON, initialFormat, asyncapiYAMLorJSON, options) {
  await dereference(parsedJSON, initialFormat, asyncapiYAMLorJSON, { ...options, circular: true });
