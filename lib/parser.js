...
/**
 * 
 * @param {object} refParser refParser 
 ...
 * @param {string} originalAsyncAPIDocument original AsyncAPI document
 * @param {string} fileFormat information of the document was originally JSON or YAML
 * @param {object} parsedAsyncAPIDocument parsed AsyncAPI document
 * @param {string} pathToPayload pathToPayload
 */
