...
const IntentAsyncAPIDocument = require('./intent-models/asyncapi').IntentAsyncAPIDocument;
 ...
 * @returns {Promise<any>} The parsed AsyncAPI document.
 */
 ...
 */
async function parseIntents(asyncapiYAMLorJSON, options = {}) {
  return new IntentAsyncAPIDocument(await parseToJson(asyncapiYAMLorJSON, options));
}
...
async function parse(asyncapiYAMLorJSON, options = {}) {
  return new AsyncAPIDocument(await parseToJson(asyncapiYAMLorJSON, options));
}
