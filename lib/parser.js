...
const { validateChannelParams, validateServerVariables, validateOperationId, validateServerSecuritySchemaMapping } = require('./customValidators.js');
...
async function customDocumentOperations(js, asyncapiYAMLorJSON, initialFormat, options) {
  ...
  validateServerSecuritySchemaMapping(js, asyncapiYAMLorJSON, initialFormat);
