...
/**
 * @param {any} refParser reference
 * @param {any} parsedJSON json
 * @param {any} initialFormat initial format
 * @param {any} asyncapiYAMLorJSON async API yaml or json
 * @param {any} options options
 * @returns {any} refparser
 */
...
/**
 * @param {any} msg  msg
 * @param {any} originalAsyncAPIDocument document
 * @param {any} fileFormat format
 * @param {any} parsedAsyncAPIDocument parsed API document
 * @param {any} pathToPayload path
 */
