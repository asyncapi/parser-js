...
describe('License model', function() {
  describe('.name()', function() {
    it('should return the value', function() {
      const doc = serializeInput<v3.LicenseObject>({ name: 'Apache 2.0' });
  ...
  describe('.hasUrl()', function() {
    it('should return true when there is a value', function() {
      const doc = serializeInput<v3.LicenseObject>({ url: 'https://www.apache.org/licenses/LICENSE-2.0.html' });
      const d = new License(doc);
      expect(d.hasUrl()).toEqual(true);
    });
    
    it('should return false when there is no value', function() {
      const doc = serializeInput<v3.LicenseObject>({});
      const d = new License(doc);
