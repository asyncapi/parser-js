...
export class Schema extends BaseModel<v2.AsyncAPISchemaObject, { id: string, parent: Schema | null }> implements SchemaInterface {
  ...
  contains(): SchemaInterface | undefined {
    if (typeof this._json.contains !== 'object') return;
  ...
  definitions(): Record<string, SchemaInterface> | undefined {
    if (typeof this._json.definitions !== 'object') return undefined;
  ...
  discriminator(): string | undefined {
    ...
    if (typeof this._json.else !== 'object') return;
  ...
  if(): SchemaInterface | undefined {
    if (typeof this._json.if !== 'object') return;
  ...
  items(): SchemaInterface | Array<SchemaInterface> | undefined {
    if (typeof this._json.items !== 'object') return;
  ...
  not(): SchemaInterface | undefined {
    if (typeof this._json.not !== 'object') return;
  ...
  patternProperties(): Record<string, SchemaInterface> | undefined {
    if (typeof this._json.patternProperties !== 'object') return undefined;
  ...
  properties(): Record<string, SchemaInterface> | undefined {
    if (typeof this._json.properties !== 'object') return undefined;
  ...
  property(key: string): SchemaInterface | undefined {
    if (this._json.properties === undefined || this._json.properties[key] === undefined) return undefined;
  ...
  propertyNames(): SchemaInterface | undefined {
    if (typeof this._json.propertyNames !== 'object') return;
  ...
  then(): SchemaInterface | undefined {
    if (typeof this._json.then !== 'object') return;
