...
describe("validateServerVariables()", function () {
  ...
  it("should successfully validate the server variables that has enum and an example match one of them", async function () {
    ...
    expect(validateServerVariables(parsedInput, inputString, input)
    ).to.equal(true);
  });
  ...
  it("should throw error on the server variables has one example and it doesn't match any of provided enum", async function () {
    const inputString = `{ 
      "servers": {
        "dummy":
        {
  ...
  it("should throw error on the server variables has one example and only one of them match enum list, but the rest don't", async function () {
    const inputString = `{ 
      "servers": {
        "dummy":
        {
