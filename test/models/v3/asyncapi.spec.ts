...
describe('AsyncAPIDocument model', function() {
  ...
  describe('.allServerVariables()', function() {
    it('should return a collection of serverVariables', function() {
      const doc = serializeInput<v3.AsyncAPIObject>({ servers: {serv1: {variables: {var3: {enum: []}}}},components: { serverVariables: { var1: { enum: [] }, var2: { enum: [] } } } });
      const d = new AsyncAPIDocument(doc);
  ...
  describe('.allParameters()', function() {
    it('should return a collection of channelParameters', function() {
      const doc = serializeInput<v3.AsyncAPIObject>({ channels: {chan1: {parameters: {par3: {enum: []}}},components: { parameters: { par1: { enum: [] }, par2: { enum: [] } } } }});
      const d = new AsyncAPIDocument(doc);
  ...
  describe('.allCorrelationIds()', function() {
    it('should return a collection of correlationIds', function() {
      const doc = serializeInput<v3.AsyncAPIObject>({ channels: {chan1: {messages: {mess1: {traits: [{correlationId: {location: ''}}],correlationId: {location: ''}}}}},components: { correlationIds: { correlationId1: {}, correlationId2: {} } } });
      const d = new AsyncAPIDocument(doc);
  ...
  describe('.allTags()', function() {
    it('should return a collection of tags', function() {
      const doc = serializeInput<v3.AsyncAPIObject>({info: { tags: [{ name: 'tag1' }, { name: 'tag2' }] }});
      const d = new AsyncAPIDocument(doc);
  ...
  describe('.allOperationTraits()', function() {
    it('should return a collection of operationTraits', function() {
      const doc = serializeInput<v3.AsyncAPIObject>({ components: { operationTraits: { trait1: {}, trait2: {} } } });
      const d = new AsyncAPIDocument(doc);
  ...
  describe('.allMessageTraits()', function() {
    it('should return a collection of messageTraits', function() {
      const doc = serializeInput<v3.AsyncAPIObject>({ components: { messageTraits: { trait1: {name: ''}, trait2: {name: ''} } } });
      const d = new AsyncAPIDocument(doc);
  ...
  describe('.allServerBindings()', function() {
    it('should return a collection of serverBindings', function() {
      const doc = serializeInput<v3.AsyncAPIObject>({ components: { serverBindings: { binding1: {ws: {}}, binding2: {kafka: {}} } } });
      const d = new AsyncAPIDocument(doc);
  ...
  describe('.allChannelBindings()', function() {
    it('should return a collection of channelBindings', function() {
      const doc = serializeInput<v3.AsyncAPIObject>({ components: { channelBindings: { binding1: {ws: {}}, binding2: {http: {}} } } });
      const d = new AsyncAPIDocument(doc);
  ...
  describe('.allOperationBindings()', function() {
    it('should return a collection of operationBindings', function() {
      const doc = serializeInput<v3.AsyncAPIObject>({ components: { operationBindings: { binding1: {ws: {}}, binding2: {mqtt: {}} } } });
      const d = new AsyncAPIDocument(doc);
  ...
  describe('.allMessageBindings()', function() {
    it('should return a collection of messageBindings', function() {
      const doc = serializeInput<v3.AsyncAPIObject>({ components: { messageBindings: { websocket: { ws: {} }, http: {http: {}} } } });
      const d = new AsyncAPIDocument(doc);
