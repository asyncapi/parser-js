...
describe('Operation model', function() {
  ...
  //     const doc = {};
  //     const d = new Operation({ action: 'send', channel: {} }, { asyncapi: { parsed: { servers: { production: {}, development: {} }, channels: { 'user/signup': { publish: doc } } } } as any, pointer: '', id: 'operation'});
  ...
  //     const doc = {};
  //     const d = new Operation({ action: 'send', channel: {} }, { asyncapi: { parsed: { servers: { production: {}, development: {} }, channels: { 'user/signup': { publish: doc, servers: ['production'] } } } } as any, pointer: '', id: 'operation'});
  //     expect(d.servers()).toBeInstanceOf(Servers);
  ...
  //     const doc = {};
  //     const d = new Operation({ action: 'send', channel: {} }, { asyncapi: { parsed: { servers: { production: {}, development: {} }, channels: { 'user/signup': { publish: doc, servers: ['production'] }, 'user/logout': { subscribe: doc } } } } as any, pointer: '', id: 'operation' });
  //     expect(d.servers()).toBeInstanceOf(Servers);
  //     expect(d.servers().all()).toHaveLength(2);
  //     expect(d.servers().all()[0]).toBeInstanceOf(Server);
  //     expect(d.servers().all()[0].id()).toEqual('production');
