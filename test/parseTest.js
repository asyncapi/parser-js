...
const inputWithOpenAPIOneOf = fs.readFileSync(path.resolve(__dirname, "./asyncapi-oneOf.yaml"), 'utf8');
...
describe('parse()', function () {
  ...
  it('should parse oneOf document', async function () {
    const result = await parser.parse(inputWithOpenAPIOneOf, { path: __filename });
    // await expect(JSON.stringify(result)).to.equal(outputWithOpenAPI);
  });
