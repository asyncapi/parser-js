...
const outputJSON = '{"asyncapi":"2.0.0","info":{"title":"My API","version":"1.0.0"},"channels":{"mychannel":{"publish":{"externalDocs":{"x-extension":true,"url":"https://company.com/docs"},"message":{"payload":{"type":"object","properties":{"name":{"type":"string","x-parser-schema-id":"name"},"test":{"type":"object","properties":{"testing":{"type":"string","x-parser-schema-id":"testing"}},"x-parser-schema-id":"test"}},"x-parser-schema-id":"testSchema"},"x-some-extension":"some extension","x-parser-original-traits":[{"x-some-extension":"some extension"}],"schemaFormat":"application/vnd.aai.asyncapi;version=2.0.0","x-parser-message-name":"testMessage"},"x-parser-original-traits":[{"externalDocs":{"url":"https://company.com/docs"}}]}}},"components":{"messages":{"testMessage":{"payload":{"type":"object","properties":{"name":{"type":"string","x-parser-schema-id":"name"},"test":{"type":"object","properties":{"testing":{"type":"string","x-parser-schema-id":"testing"}},"x-parser-schema-id":"test"}},"x-parser-schema-id":"testSchema"},"x-some-extension":"some extension","x-parser-original-traits":[{"x-some-extension":"some extension"}],"schemaFormat":"application/vnd.aai.asyncapi;version=2.0.0","x-parser-message-name":"testMessage"}},"schemas":{"testSchema":{"type":"object","properties":{"name":{"type":"string","x-parser-schema-id":"name"},"test":{"type":"object","properties":{"testing":{"type":"string","x-parser-schema-id":"testing"}},"x-parser-schema-id":"test"}},"x-parser-schema-id":"testSchema"}},"messageTraits":{"extension":{"x-some-extension":"some extension"}},"operationTraits":{"docs":{"externalDocs":{"url":"https://company.com/docs"}}}}}';
const outputJsonNoApplyTraits = '{"asyncapi":"2.0.0","info":{"title":"My API","version":"1.0.0"},"channels":{"mychannel":{"publish":{"traits":[{"externalDocs":{"url":"https://company.com/docs"}}],"externalDocs":{"x-extension":true,"url":"https://irrelevant.com"},"message":{"traits":[{"x-some-extension":"some extension"}],"payload":{"type":"object","properties":{"name":{"type":"string","x-parser-schema-id":"name"},"test":{"type":"object","properties":{"testing":{"type":"string","x-parser-schema-id":"testing"}},"x-parser-schema-id":"test"}},"x-parser-schema-id":"testSchema"},"schemaFormat":"application/vnd.aai.asyncapi;version=2.0.0","x-parser-message-name":"testMessage"}}}},"components":{"messages":{"testMessage":{"traits":[{"x-some-extension":"some extension"}],"payload":{"type":"object","properties":{"name":{"type":"string","x-parser-schema-id":"name"},"test":{"type":"object","properties":{"testing":{"type":"string","x-parser-schema-id":"testing"}},"x-parser-schema-id":"test"}},"x-parser-schema-id":"testSchema"},"schemaFormat":"application/vnd.aai.asyncapi;version=2.0.0","x-parser-message-name":"testMessage"}},"schemas":{"testSchema":{"type":"object","properties":{"name":{"type":"string","x-parser-schema-id":"name"},"test":{"type":"object","properties":{"testing":{"type":"string","x-parser-schema-id":"testing"}},"x-parser-schema-id":"test"}},"x-parser-schema-id":"testSchema"}},"messageTraits":{"extension":{"x-some-extension":"some extension"}},"operationTraits":{"docs":{"externalDocs":{"url":"https://company.com/docs"}}}}}';
...
const outputWithRAML = JSON.stringify({ "asyncapi": "2.0.0", "info": { "title": "Example using RAML data types", "version": "1.0.0" }, "channels": { "mychannel": { "publish": { "message": { "payload": { "type": "object", "examples": [{ "title": "A book", "author": "An author" }], "additionalProperties": true, "required": ["title", "author"], "properties": { "title": { "type": "string", "x-parser-schema-id": "title" }, "author": { "type": "string", "examples": ["Eva"], "x-parser-schema-id": "author" } }, "x-parser-schema-id": "<anonymous-schema-1>" }, "x-parser-original-schema-format": "application/raml+yaml;version=1.0", "x-parser-original-payload": "#%RAML 1.0 Library\ntypes:\n  tmpType:\n    type: object\n    properties:\n      title: string\n      author:\n        type: string\n        examples:\n          anExample: Eva\n    examples:\n      exampleOne:\n        title: A book\n        author: An author\n", "schemaFormat": "application/vnd.aai.asyncapi;version=2.0.0", "x-parser-message-name": "testMessage" } } }, "otherchannel": { "subscribe": { "message": { "payload": { "minProperties": 1, "maxProperties": 50, "additionalProperties": false, "discriminator": "breed", "discriminatorValue": "CatOne", "type": "object", "required": ["proscons", "name", "breed", "age", "rating", "year_of_birth", "time_of_birth", "addition_date", "removal_date", "photo", "description", "character", "siblings", "parents", "ratingHistory", "additionalData"], "properties": { "proscons": { "anyOf": [true, true], "x-parser-schema-id": "proscons" }, "name": true, "breed": true, "age": true, "rating": { "type": "integer", "multipleOf": 5, "example": { "displayName": "Cat's rating", "description": "Rating of cat's awesomeness", "strict": false, "value": 50 }, "x-parser-schema-id": "rating" }, "year_of_birth": { "type": "string", "format": "date", "x-parser-schema-id": "year_of_birth" }, "time_of_birth": { "type": "string", "format": "time", "x-parser-schema-id": "time_of_birth" }, "dt_of_birth": { "type": "string", "format": "date-time-only", "x-parser-schema-id": "dt_of_birth" }, "addition_date": { "type": "string", "format": "rfc2616", "x-parser-schema-id": "addition_date" }, "removal_date": { "type": "string", "format": "date-time", "x-parser-schema-id": "removal_date" }, "photo": { "type": "string", "minLength": 1, "maxLength": 307200, "x-parser-schema-id": "photo" }, "description": { "type": "null", "x-parser-schema-id": "description" }, "habits": { "type": "string", "x-parser-schema-id": "habits" }, "character": { "anyOf": [{ "type": "null", "x-parser-schema-id": "<anonymous-schema-8>" }, { "type": "string", "x-parser-schema-id": "<anonymous-schema-9>" }], "x-parser-schema-id": "character" }, "siblings": { "type": "array", "items": { "type": "string", "x-parser-schema-id": "<anonymous-schema-10>" }, "x-parser-schema-id": "siblings" }, "parents": { "type": "array", "items": true, "x-parser-schema-id": "parents" }, "ratingHistory": { "type": "array", "items": { "anyOf": [{ "type": "integer", "x-parser-schema-id": "<anonymous-schema-13>" }, { "type": "number", "x-parser-schema-id": "<anonymous-schema-14>" }], "x-parser-schema-id": "<anonymous-schema-12>" }, "x-parser-schema-id": "ratingHistory" }, "additionalData": { "type": "object", "additionalProperties": true, "required": ["weight"], "properties": { "weight": { "type": "number", "x-parser-schema-id": "weight" } }, "x-parser-schema-id": "additionalData" } }, "x-parser-schema-id": "<anonymous-schema-2>" }, "x-parser-original-schema-format": "application/raml+yaml;version=1.0", "x-parser-original-payload": "#%RAML 1.0 Library\ntypes:\n  tmpType:\n    type:\n      - CatWithAddress\n      - CatWithCity\n    minProperties: 1\n    maxProperties: 50\n    additionalProperties: false\n    discriminator: breed\n    discriminatorValue: CatOne\n    properties:\n      proscons:\n        type: CatPros | CatCons\n        required: true\n      name:\n        type: CatName\n        amazing: true\n      breed:\n        type: CatBreed\n      age: CatAge\n      rating:\n        type: integer\n        multipleOf: 5\n        example:\n          displayName: Cat's rating\n          description: Rating of cat's awesomeness\n          strict: false\n          value: 50\n      year_of_birth: date-only\n      time_of_birth: time-only\n      dt_of_birth:\n        type: datetime-only\n        required: false\n      addition_date:\n        type: datetime\n        format: rfc2616\n      removal_date:\n        type: datetime\n      photo:\n        type: file\n        fileTypes:\n          - image/jpeg\n          - image/png\n        minLength: 1\n        maxLength: 307200\n      description: nil\n      habits?: string\n      character: nil | string\n      siblings: 'string[]'\n      parents: 'CatName[]'\n      ratingHistory: '(integer | number)[]'\n      additionalData:\n        type:\n          type: object\n          properties:\n            weight: number\n", "schemaFormat": "application/vnd.aai.asyncapi;version=2.0.0", "x-parser-message-name": "<anonymous-message-2>" } } } }, "components": { "messages": { "testMessage": { "payload": { "type": "object", "examples": [{ "title": "A book", "author": "An author" }], "additionalProperties": true, "required": ["title", "author"], "properties": { "title": { "type": "string", "x-parser-schema-id": "title" }, "author": { "type": "string", "examples": ["Eva"], "x-parser-schema-id": "author" } }, "x-parser-schema-id": "<anonymous-schema-1>" }, "x-parser-original-schema-format": "application/raml+yaml;version=1.0", "x-parser-original-payload": "#%RAML 1.0 Library\ntypes:\n  tmpType:\n    type: object\n    properties:\n      title: string\n      author:\n        type: string\n        examples:\n          anExample: Eva\n    examples:\n      exampleOne:\n        title: A book\n        author: An author\n", "schemaFormat": "application/vnd.aai.asyncapi;version=2.0.0", "x-parser-message-name": "testMessage" } } } });
