...
const invalidYAML = fs.readFileSync(
  path.resolve(__dirname, './wrong/malformed-asyncapi.yaml'),
  'utf8'
);
const inputYAML = fs.readFileSync(
  path.resolve(__dirname, './good/asyncapi.yaml'),
  'utf8'
);
const inputYAMLNoComponents = fs.readFileSync(
  path.resolve(__dirname, './good/asyncapi-no-components.yml'),
  'utf8'
);
const inputYAMLNoChannels = fs.readFileSync(
  path.resolve(__dirname, './good/asyncapi-no-channels.yml'),
  'utf8'
);
const inputYAMLMessagesChannels = fs.readFileSync(
  path.resolve(__dirname, './good/asyncapi-messages-channels.yml'),
  'utf8'
);
const inputYAMLCircular = fs.readFileSync(
  path.resolve(__dirname, './good/circular-refs.yaml'),
  'utf8'
);
const inputJSON = fs.readFileSync(
  path.resolve(__dirname, './good/asyncapi.json'),
  'utf8'
);
const invalidAsyncapiYAML = fs.readFileSync(
  path.resolve(__dirname, './wrong/invalid-asyncapi.yaml'),
  'utf8'
);
const invalidAsyncpiJSON = fs.readFileSync(
  path.resolve(__dirname, './wrong/invalid-asyncapi.json'),
  'utf8'
);
...
const outputJSONNoChannels =
  '{"asyncapi":"2.0.0","info":{"title":"My API","version":"1.0.0"},"channels":{},"components":{"messages":{"testMessage":{"payload":{"type":"object","properties":{"name":{"type":"string","x-parser-schema-id":"<anonymous-schema-3>"}},"x-parser-schema-id":"testSchema"},"x-some-extension":"some extension","headers":{"type":"object","properties":{"some-common-header":{"type":"string","x-parser-schema-id":"<anonymous-schema-2>"}},"x-parser-schema-id":"<anonymous-schema-1>"},"x-parser-original-traits":[{"x-some-extension":"some extension","headers":{"type":"object","properties":{"some-common-header":{"type":"string","x-parser-schema-id":"<anonymous-schema-5>"}},"x-parser-schema-id":"<anonymous-schema-4>"}}],"x-parser-original-schema-format":"application/vnd.aai.asyncapi;version=2.0.0","x-parser-original-payload":{"type":"object","properties":{"name":{"type":"string"}}},"schemaFormat":"application/vnd.aai.asyncapi;version=2.0.0","x-parser-message-parsed":true,"x-parser-message-name":"testMessage"}},"schemas":{"testSchema":{"type":"object","properties":{"name":{"type":"string","x-parser-schema-id":"<anonymous-schema-3>"}},"x-parser-schema-id":"testSchema"}},"messageTraits":{"extension":{"x-some-extension":"some extension","headers":{"type":"object","properties":{"some-common-header":{"type":"string","x-parser-schema-id":"<anonymous-schema-5>"}},"x-parser-schema-id":"<anonymous-schema-4>"}}}},"x-parser-spec-parsed":true}';
...
const invalidRootWithDuplicateTags = fs.readFileSync(
  path.resolve(
    __dirname,
    './wrong/invalid-asyncapi-root-with-duplicate-tags.yaml'
  ),
  'utf8'
);
const invalidRootWithDuplicateTagsJSON =
  '{"asyncapi":"2.0.0","tags":[{"name":"user","description":"user signed up"},{"name":"user"}],"info":{"title":"Signup service example (internal)","version":"0.1.0"},"channels":{"/user/signedup":{"subscribe":{"message":{"payload":{"type":"object","properties":{"email":{"type":"string","format":"email"}}}}}}}}';

// Source: https://github.com/asyncapi/tck/blob/master/tests/asyncapi-2.0/Operation%20Object/invalid-duplicate-tags.yaml
const invalidOperationWithDuplicateTags = fs.readFileSync(
  path.resolve(__dirname, './wrong/invalid-operation-with-duplicate-tags.yaml'),
  'utf8'
);
const invalidOperationWithDuplicateTagsJSON =
  '{"asyncapi":"2.0.0","info":{"title":"Signup service example (internal)","version":"0.1.0"},"channels":{"/user/signedup":{"subscribe":{"operationId":"userSignedUp","summary":"user signed up","description":"user signed up to load some data","message":{"payload":{"type":"object","properties":{"email":{"type":"string","format":"email"}}}},"tags":[{"name":"user","description":"user signed up"},{"name":"user"}]}}}}';
...
const invalidOperationTraitsWithDuplicateTags = fs.readFileSync(
  path.resolve(
    __dirname,
    './wrong/invalid-operation-traits-with-duplicate-tags.yaml'
  ),
  'utf8'
);
const invalidOperationTraitsWithDuplicateTagsJSON =
  '{"asyncapi":"2.0.0","info":{"title":"Signup service example (internal)","version":"0.1.0"},"channels":{"/user/signedup":{"subscribe":{"message":{"payload":{"type":"object","properties":{"email":{"type":"string","format":"email"}}}},"traits":[{"tags":[{"description":"user signed up","name":"user"},{"name":"user"}]}]}}},"components":{"operationTraits":{"userSignedUpTrait":{"tags":[{"name":"user","description":"user signed up"},{"name":"user"}]}}}}';

// Source: https://github.com/asyncapi/tck/blob/master/tests/asyncapi-2.0/Message%20Object/invalid-duplicate-tags.yaml
const invalidMessageWithDuplicateTags = fs.readFileSync(
  path.resolve(__dirname, './wrong/invalid-message-with-duplicate-tags.yaml'),
  'utf8'
);
const invalidMessageWithDuplicateTagsJSON =
  '{"asyncapi":"2.0.0","info":{"title":"Signup service example (internal)","version":"0.1.0"},"channels":{"/user/signedup":{"subscribe":{"message":{"contentType":"application/json","tags":[{"name":"user","description":"user signed up"},{"name":"user"}]}}}}}';

const invalidMessageOneOfWithDuplicateTags = fs.readFileSync(
  path.resolve(
    __dirname,
    './wrong/invalid-operation-with-oneof-and-duplicate-tags.yaml'
  ),
  'utf8'
);
...
const invalidMessageTraitWithDuplicateTags = fs.readFileSync(
  path.resolve(
    __dirname,
    './wrong/invalid-message-traits-with-duplicate-tags.yaml'
  ),
  'utf8'
);
...
describe('parse()', function () {
  ...
  it('should parse YAML correctly when no components object', async function () {
    const result = await parser.parse(inputYAMLNoComponents, {
      path: __filename,
    });
  ...
  it('should apply traits to messages even with empty channels object', async function () {
    const result = await parser.parse(inputYAMLNoChannels, {
      path: __filename,
    });
  ...
  it('should apply traits to messages used and not used in a channel', async function () {
    const result = await parser.parse(inputYAMLMessagesChannels, {
      path: __filename,
    });
  ...
  it('should fail when asyncapi is not valid (ref with line break) (yaml)', async function () {
    const expectedErrorObject = {
      ...
      validationErrors: [
        {
          title:
            '/channels/smartylighting~1streetlights~11~10~1action~1{streetlightId}~1turn~1off/parameters/streetlightId/$ref should match format "uri-reference"',
          location: {
            jsonPointer:
              '/channels/smartylighting~1streetlights~11~10~1action~1{streetlightId}~1turn~1off/parameters/streetlightId/$ref',
            startLine: 67,
            startColumn: 9,
    ...
    await checkErrorWrapper(async () => {
      await parser.parse(
        fs.readFileSync(
          path.resolve(
            __dirname,
            './wrong/invalid-asyncapi-with-ref-with-line-break.yaml'
          ),
          'utf8'
        ),
        {
  ...
  it('should fail to resolve relative files when options.path is not provided', async function () {
    const expectedErrorObject = {
      ...
      title: `Error opening file "${path.resolve(
        process.cwd(),
        'refs/refed.yaml'
  ...
  it('should offer information about missing HTTP $refs', async function () {
    const expectedErrorObject = {
      type: 'https://github.com/asyncapi/parser-js/dereference-error',
      title:
        'Error downloading https://example.com/components/messages/testMessage \nHTTP ERROR 404',
      refs: [
        {
    ...
    await checkErrorWrapper(async () => {
      await parser.parse(
        fs.readFileSync(
          path.resolve(__dirname, './wrong/inexisting-http-ref.yaml'),
          'utf8'
        ),
        {
  ...
  it('should offer information about missing root $refs', async function () {
    ...
    await checkErrorWrapper(async () => {
      await parser.parse(
        fs.readFileSync(
          path.resolve(__dirname, './wrong/inexisting-root-ref.yaml'),
          'utf8'
        ),
        {
          path: 'https://example.com',
  ...
  it('should offer information about missing local $refs', async function () {
    ...
    await checkErrorWrapper(async () => {
      await parser.parse(
        fs.readFileSync(
          path.resolve(__dirname, './wrong/inexisting-local-ref.yaml'),
          'utf8'
        ),
        {
          path: 'https://example.com',
  ...
  it('should throw proper error even if issue is inside $refed file of a $refed file', async function () {
    ...
    await checkErrorWrapper(async () => {
      await parser.parse(
        fs.readFileSync(
          path.resolve(__dirname, './wrong/good-ref-to-broken-file.yaml'),
          'utf8'
        ),
        {
          path: __filename,
  ...
  it('should throw error if document is invalid YAML', async function () {
    const expectedErrorObject = {
      ...
      title: 'The provided YAML is not valid.',
      detail:
        'bad indentation of a mapping entry at line 19, column 11:\n              $ref: "#/components/schemas/sentAt"\n              ^',
      location: {
        startOffset: offset(460, 19),
        startLine: 19,
        startColumn: 11,
      },
    };
  ...
  it('should throw error if document is invalid JSON', async function () {
    const expectedErrorObject = {
      ...
      detail:
        'Unexpected token j in JSON at position 12 while parsing near \' {"invalid "json" }\'',
  ...
  it('Should include schemas after circular property', async function () {
    const input =
      '{"asyncapi":"2.0.0","info":{"title":"My API","version":"1.0.0"},"channels":{"test":{"publish":{"message":{"payload":{"$ref":"#/components/schemas/testSchema"}}}}},"components":{"schemas":{"testSchema":{"$id":"testSchema","type":"object","test":true,"properties":{"recursiveTestProp":{"$ref":"#/components/schemas/testSchema"},"testProp":{"$id":"testString","type":"string"}}}}}}';
    ...
    expect(schemaKeys).to.deep.equal(['testSchema', 'testString']);
  });
  ...
  it('should properly mark circular references', async function () {
    ...
    expect(result.components().schema('RecursiveSelf').isCircular()).to.equal(
      false
    );
    expect(result.components().schema('NonRecursive').isCircular()).to.equal(
      false
    );
    expect(
      result
        .components()
        .schema('RecursiveSelf')
        .properties()
        ['selfChildren'].isCircular()
    ).to.equal(false);
    expect(
      result
        .components()
    ...
    expect(result.components().schema('NormalSchemaC').isCircular()).to.equal(
      false
    );

    // NestedAllOfSchema has circular reference
    expect(
      result.components().schema('NestedAllOfSchema').allOf()[0].isCircular()
    ).to.equal(false);
    expect(
      result
        .components()
        .schema('NestedAllOfSchema')
        .allOf()[1]
        .properties()
        ['parent'].allOf()[0]
        .isCircular()
    ...
    expect(
      result.components().schema('OneOf').properties()['kind'].isCircular()
    ).to.equal(false);
    expect(
      result
        .components()
    ...
    expect(
      result.components().schema('AnyOf').anyOf()[5].isCircular()
    ).to.equal(false);
    expect(
      result.components().schema('AnyOf').anyOf()[5].items().isCircular()
    ).to.equal(true);

    // external/file channel has deep circular reference
    expect(
      result
        .channel('external/file')
        .publish()
        .messages()[0]
        .payload()
        .properties()
    ...
    expect(
      result
        ...
        .schema('RecursiveSelf')
        .properties()
        ['selfSomething'].properties()
        ['test'].properties()
        ['ancestorChildren'].isCircular()
    ).to.equal(false);
    expect(
      result
        .components()
        ...
        ['selfSomething'].properties()
        ['test'].properties()
        ['ancestorChildren'].items()
        .isCircular()
    ).to.equal(true);
    expect(
      result
        .components()
        .schema('RecursiveAncestor')
        .properties()
        ['ancestorChildren'].isCircular()
    ).to.equal(false);
    expect(
    ...
    expect(
      result.components().schema('RecursiveComplex').contains().isCircular()
    ).to.equal(true);
    expect(
      result.components().schema('RecursiveComplex').items()[0].isCircular()
    ).to.equal(false);
    expect(
      result.components().schema('RecursiveComplex').items()[1].isCircular()
    ).to.equal(true);
    expect(
      result.components().schema('RecursiveComplex').then().isCircular()
    ).to.equal(true);
    expect(
      result
        .components()
        .schema('RecursiveComplex')
        .if()
        .properties()
        ['ancestorChildren'].isCircular()
    ).to.equal(false);
  ...
  it('should throw error that the provided operation object has duplicate tags', async function () {
    ...
    const expectedErrorObject = {
      ...
      validationErrors: [
        {
          title:
            '/user/signedup/subscribe/tags contains duplicate tag names: user',
          location: {
  ...
  it('should throw error that the provided operation trait object has duplicate tags', async function () {
    ...
    const expectedErrorObject = {
      ...
      validationErrors: [
        {
          title:
            'operationTraits/userSignedUpTrait/tags contains duplicate tag names: user',
          location: {
  ...
  it('should throw error that the provided message object has duplicate tags', async function () {
    ...
    const expectedErrorObject = {
      ...
      validationErrors: [
        {
          title:
            '/user/signedup/subscribe/message/tags contains duplicate tag names: user',
          location: {
  ...
  it('should throw error that the provided message objects in oneOf has duplicate tags', async function () {
    ...
    const expectedErrorObject = {
      ...
      validationErrors: [
        {
          title:
            '/user/signedup/publish/message/oneOf/0/tags contains duplicate tag names: user',
          location: {
            jsonPointer:
              '/channels/~1user~1signedup/publish/message/oneOf/0/tags',
          },
        },
        {
          title:
            '/user/signedup/publish/message/oneOf/1/tags contains duplicate tag names: user',
          location: {
            jsonPointer:
              '/channels/~1user~1signedup/publish/message/oneOf/1/tags',
          },
        },
        {
          title:
            '/user/signedup/publish/message/oneOf/2/tags contains duplicate tag names: user3',
          location: {
            jsonPointer:
              '/channels/~1user~1signedup/publish/message/oneOf/2/tags',
            startLine: 18,
            startColumn: 13,
        ...
        {
          title:
            'messages/testMessage1/tags contains duplicate tag names: user',
          location: {
        ...
        {
          title:
            'messages/testMessage2/tags contains duplicate tag names: user',
          location: {
  ...
  it('should throw error that the provided message trait object has duplicate tags', async function () {
    ...
    const expectedErrorObject = {
      ...
      validationErrors: [
        {
          title:
            'messageTraits/signedUpMessage/tags contains duplicate tag names: user',
          location: {
...
it('should not apply traits', async function () {
  ...
  const result = await parser.parse(inputYAML, {
    path: __filename,
    applyTraits: false,
  });
...
it('should throw schema-parser-not-registered error on unrecognized schema', async function () {
  const notRegisteredFormatFile = fs.readFileSync(
    path.resolve(__dirname, './wrong/unknown-schema-format.yaml'),
    'utf8'
  );
  const errorObject = {
...
it('should parse and include examples', async function () {
  let result = await parser.parse(
    fs.readFileSync(
      path.resolve(__dirname, './good/asyncapi-messages-example.yml'),
      'utf8'
    ),
    { path: __filename }
  );
  expect(
    result.channel('myChannel').subscribe().messages()[0].examples()[0].name
  ).to.equal('Example1');
  expect(
    result.channel('myChannel').subscribe().messages()[0].examples()[0].summary
  ).to.equal('Example1 summary');
  expect(
    result.channel('myChannel').subscribe().messages()[0].examples()[0].payload
      .name
  ).to.equal('My name');
  expect(
    result.channel('myChannel').subscribe().messages()[0].examples()[0].headers[
      'some-common-header'
    ]
  ).to.equal('My header');
  ...
  result = await parser.parse(
    fs.readFileSync(
      path.resolve(__dirname, './good/asyncapi-messages-example-payload.yml'),
      'utf8'
    ),
    { path: __filename }
  );
  ...
  result = await parser.parse(
    fs.readFileSync(
      path.resolve(__dirname, './good/asyncapi-messages-example-headers.yml'),
      'utf8'
    ),
    { path: __filename }
  );
  ...
  result = await parser.parse(
    fs.readFileSync(
      path.resolve(__dirname, './good/asyncapi-messages-example-optional.yml'),
      'utf8'
    ),
    { path: __filename }
  );
  ...
  await checkErrorWrapper(async () => {
    await parser.parse(
      fs.readFileSync(
        path.resolve(
          __dirname,
          './wrong/invalid-asyncapi-messages-example.yml'
        ),
        'utf8'
      ),
      { path: __filename }
...
describe('memory usage', function () {
  it('should use this same instance of validation function in each call', async function () {
    ...
    const asyncapi = fs.readFileSync(
      path.resolve(__dirname, './good/zbos_mqtt-all-asyncapi.json'),
      'utf8'
    );
...
describe('registerSchemaParser()', function () {
  ...
  it('should show that for 2.0 default schema format is 2.0 and for 2.1 it is 2.1 and so on', async function () {
    ...
    const result21 = await parser.parse(
      fs.readFileSync(
        path.resolve(__dirname, './good/asyncapi-messages-example-payload.yml'),
        'utf8'
      ),
    ...
    const result22 = await parser.parse(
      fs.readFileSync(
        path.resolve(__dirname, './good/asyncapi-messages-example.yml'),
        'utf8'
      ),
    ...
    expect(
      result20.channel('mychannel').publish().messages()[0].schemaFormat()
    ).to.equal('application/vnd.aai.asyncapi;version=2.0.0');
    expect(
      result21.channel('myChannel').subscribe().messages()[0].schemaFormat()
    ).to.equal('application/vnd.aai.asyncapi;version=2.1.0');
    expect(
      result22.channel('myChannel').subscribe().messages()[0].schemaFormat()
    ).to.equal('application/vnd.aai.asyncapi;version=2.2.0');
  });
});
